...
function PsgeoLang(language) {
    ...
    rockTypeValueTexts["en"] = {
        ...
        "sandstone": "sandstone",
	"mudrock": "mudrock",
        "limestone": "limestone/dolomite",	// added dolomite
	"gypsum": "gypsum",			// added gypsum
	"salt": "salt",				// added salt
        "marble": "marble",
        "granite": "non-volcanic, non-sedimentary", // text changed
        "other": "other rock",			// was other rock
        "unknown": "unknown"
    };
    rockTypeValueTexts["fi"] = {
        "volcanic": "vulkaaninen",
        "sandstone": "hiekkakivi",
        "mudrock": "savikivi",			// monenlaiset savikivet
        "limestone": "kalkkikivi/dolomiitti",	// added dolomite
        "gypsum": "kipsi",			// added gypsum
	"salt": "suola",			// added salt
        "marble": "marmori",
        "granite": "muu kivi kuin vulkaaninen tai sedimentti", // text changed
        "other": "muu kivi",
        "unknown": "ei tiedossa"
    };
    ...
    morphologyValueTexts["fi"] = {
        ...
        "volcanic": "vulkaaninen",
        "erosion": "eroosio",
        "weathering": "rapautumis",
        "crystallization": "kideonkalo",
        "organic": "koralli tai turve",
        "other": "muu",
        "unknown": "ei tiedossa"
    };
    ...
    var filterTexts = [];
    filterTexts["en"] = "filter";	// both as a header and link text :(
    ...
    moreFiltersTexts["en"] = "";			// only show an icon (psgeo.js:DomainDefaults) for filter dialog
    moreFiltersTexts["fi"] = "";			// only show an icon for filter dialog
    ...
    toolsAndAboutTexts["en"] = "";			// only show an icon (psgeo.js:DomainDefaults) for more info
    toolsAndAboutTexts["fi"] = "";			// only show an icon for more info
