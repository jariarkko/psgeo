...
// ************************************************************
// THIS COULD EXPOSE ONLY A FEW METHODS INCLUDING: getLanguage() AND getText("messageId",numberOfValues,[val0,...,valN])
//		and capitalization and a few others
//	VALUES INSERTED BY SEARCH AND REPLACE: {{VALUE0}} --> val0, {{VALUE1}} --> val1, ...
//	Example:
//		Psgeolang.getText("NumberOfResults",[3]) --> We have {{VALUEO}} results. --> We have 3 result.
//	As a result we can
//		- remove 101 functions --> easier to read
//		- have more generic code, generic/reusable functions, where functions calls take parameters --> easier to change
//		- this leads to a path of parametrization and generalization --> maybe
// ************************************************************
...
// <--- TEMPORARY
	...
	function getText(textId) {
		...
		// ELI TÄÄ SWITCH TÄSSÄ ON PERIAATTEESSA TURHA
		//    KUN SEN SAA TOIMIMAAN, VOI YLLÄ OLEVALLA JUTULA KORVATA VARMAAN KOKO KASAN
		switch (textId) {
	...
	caveletsText: 			caveletsText,				// TODO
        ...
        finnishTerrainText: 		finnishTerrainText,			// TODO getText("finnishTerrain"), EI VALMIS.
