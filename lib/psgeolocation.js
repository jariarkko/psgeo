...
function iterateOverTracks(lib,lang,trackStartDate,psgeoMap,fn,sharedCounter,sharedOutput) {
...
=======
        psgeoDebug('Getting the list of tracks for '+trackStartDate)
...
<<<<<<< HEAD
async function getFileList(lib,lang,cfg,psgeoMap,trackStartDate) { 
    // !! trackStartDate is an optional parameter. It can be undefined.
=======
async function getFileList(lib,lang,cfg,trackStartDate,psgeoMap) { 
>>>>>>> 6f06c742653e1dc7c0e85d0dcf17e81b97121d70
    ...
    // Prepare the div with initial content
    ...
    let header = document.createElement('h5')
        header.textContent = 'Download GPX files.'
        tracksForDownloadDiv.appendChild(header)
...
=======
    iterateOverTracks(lib,lang,trackStartDate,psgeoMap,fn,tracksToProcess,tracksForDownloadDiv)
>>>>>>> 6f06c742653e1dc7c0e85d0dcf17e81b97121d70
}
