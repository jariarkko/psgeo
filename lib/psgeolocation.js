...
function PsgeoLocation() {
    ...
    function getGeolocationButton(lang,lib,cfg,psgeoDomainDefault,psgeoMap,markerMyPosition,psgeoGeolocationButton,psgeoSmallDisplayMode,arrayitems,psgeoFilterPaneTexts) {
