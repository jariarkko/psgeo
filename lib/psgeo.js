...
function psgeoMoreMenuContents(db,lib,lang,map,subdiv) {
    if (psgeoDomainDefault.nameSearch) {
        ...
        subdiv.appendChild(document.createTextNode(lang.capitalize(lang.filterByNameText()) + ":"));
        subdiv.appendChild(document.createElement("br"));
    ...
    if (psgeoDomainDefault.rockTypeSearch) {
        subdiv.appendChild(document.createElement("br"));
        subdiv.appendChild(document.createTextNode(lang.capitalize(lang.filterByRockTypeText()) + ":"));
        subdiv.appendChild(document.createElement("br"));
        psgeoRockTypeFilterCheckboxes = psgeoGetRockTypeCheckboxes(lib,lang,subdiv);
    }
    if (psgeoDomainDefault.morphologySearch) {
        subdiv.appendChild(document.createElement("br"));
        subdiv.appendChild(document.createTextNode(lang.capitalize(lang.filterByMorphologyText()) + ":"));
        subdiv.appendChild(document.createElement("br"));
    ...
    if (psgeoDomainDefault.sourcesCheckboxes) {
        if (psgeoSourceFilterCheckboxes.length == 0) {
            if (psgeoDomainDefault.luolaseura) {
                subdiv.appendChild(document.createElement("br"));
                subdiv.appendChild(document.createTextNode(lang.capitalize(lang.filterBySourceText()) + ":"));
                subdiv.appendChild(document.createElement("br"));
...
function psgeoMoreMenuBringUp(db,lib,lang,map,toOpen) {
    psgeoDebug("psgeoMoreMenuBringUp point a");
    if (psgeoMoreWindow === undefined) {
        psgeoMoreWindow = new google.maps.InfoWindow;
        var div = document.createElement("div");
        //div.setAttribute("id", "Fullstats");
        var titleelement = document.createElement("h3");
        var titletext = document.createTextNode(lang.capitalize(lang.settingsText()));
        titleelement.appendChild(titletext);
        div.appendChild(titleelement);
...
function psgeoInitMorePopup(db,lib,lang,map) {
    //psgeoMoreMenuBringUp(db,lib,lang,map,false);
}
...
function psgeoGetMoreMenuButton(lang,structure,fn) {
    return(psgeoGenericMenuButton(lang,lang.moreText(),structure,fn));
}
...
function psgeoGetRockTypeCheckboxes(lib,lang,structure) {
    var types = lib.getCavingRockTypeSubActivities();
    var prefix = "Rock-";
    var result = [];
    var box;
    ...
    box = psgeoGetGenericCheckbox("Ice",lang.iceText(),structure,true);
    result.push(box);
    return(result);
}

function psgeoGetMorphologyCheckboxes(lib,lang,structure) {
    var types = lib.getCavingMorphologySubActivities();
...
function psgeoInitMap() {
    ...
    psgeoInitMorePopup($.psgeoDB,$.psgeoLib,lang,psgeoMap);
