...
function psgeoInitList(db,lib,lang,map,myPosition,tbl,psgeoDomainDefault) {
    ...
    psgeoDomainDefault.sources.forEach(function (source) { 
        ...
        $.getJSON(source.datafile,function(data) {
            ...
            if (--jsonImportsToDo == 0) psgeoFinishLoading(db,lib,lang,map,filterForMarkers,myPosition,tbl,psgeoDomainDefault);
        });
    });
}
...
function psgeoFinishLoading(db,lib,lang,map,filterForMarkers,myPosition,tbl,psgeoDomainDefault) {
...
function psgeoInitMap() {
    ...
    const psgeoModelViewerWidthPercentageSmallDisplays = cfg.psgeoModelViewerWidthPercentageSmallDisplays;
    const psgeoModelViewerWidthPercentageLargeDisplays = cfg.psgeoModelViewerWidthPercentageLargeDisplays;
    const psgeoModelViewerHeightPercentageSmallDisplays = cfg.psgeoModelViewerHeightPercentageSmallDisplays;
    const psgeoModelViewerHeightPercentageLargeDisplays = cfg.psgeoModelViewerHeightPercentageLargeDisplays;
    const psgeoViewableModel = cfg.psgeoViewableModel;
    ...
    //
    psgeoDebug("initList...");
    psgeoInitList(db, lib,lang,psgeoMap,myPosition,tbl,psgeoDomainDefault);
