...
function psgeoPopupCoordinates(lib,lang,lat,lon,includetext) {
...
function psgeoMarkerPopupText(db,lib,lang,item) {
    ...
    if (db.getItemFuzzy(item)) {
        ...
        var coordstext = psgeoPopupCoordinates(lib,
                                               ...
                                               db.getItemLon(item),
                                               true);
        coordstext += psgeoMarkerPopupAlternativeCoordinates(db,lib,lang,item);
        html += lib.htmlParagraph(coordstext);
    }
    ...
    if (db.getItemLength(item) !== undefined) {
        ...
        lengthtext += psgeoMarkerPopupAlternativeNames(db,lib,lang,item);
        ...
        typetext += psgeoMarkerPopupAlternativeNames(db,lib,lang,item);
        html += psgeoPopupText(lib,
                               lang,
                               typetext);
    }
