...
function psgeoInitPlaceAux(db,lib,lang,map,param,style) {
...
function psgeoInitPlace(db,lib,lang,map,urlParams) {
    ...
    if (image != null) {
        psgeoInitPlaceAux(db,lib,lang,map,image,"image");
    }  else if (popup !== null) {
        psgeoInitPlaceAux(db,lib,lang,map,popup,"popup");
    } else if (place !== null) {
        psgeoInitPlaceAux(db,lib,lang,map,place,"center");
    }
}
...
function psgeoInitLinkHandlers(db,lib,lang,map) {
    $(document).on("click", "a", function() {
        ...
        if (begin === "?p=") {
            ...
            psgeoInitPlaceAux(db,lib,lang,map,rest,"popup");
            return(false);
        } else if (begin === "?i=") {
            var rest = href.substring(3);
            psgeoInitPlaceAux(db,lib,lang,map,rest,"image");
            return(false);
        } else {
            return(true);
        }
