...
function psgeoInitMap() {
    ...
    if (psgeoDomainDefault.finnishTerrain) {
        ...
        psgeoMap.mapTypes.set(lang.finnishTerrainText(), $.psgeoMapFinnish);
        psgeoMap.mapTypeControlOptions.mapTypeIds[2] = lang.finnishTerrainText();
    }
