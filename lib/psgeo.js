...
function psgeoGenericMenuButton(lang,text,structure,fn) {
...
function psgeoGetOtherToolsMenuButton(lang,structure,fn) {
    return(psgeoGenericMenuButton(lang,lang.moreMapsText(),structure,fn));
}
...
function psgeoGetMoreMenuButton(lang,structure,fn) {
    return(psgeoGenericMenuButton(lang,lang.toolsAndAboutText(),structure,fn));
}
    
function psgeoGetAboutMenuButton(lang,structure,fn) {
    return(psgeoGenericMenuButton(lang,lang.aboutText(),structure,fn));
}
...
function psgeoGetCaveClassificationMenuButton(lang,structure,fn) {
    return(psgeoGenericMenuButton(lang,lang.caveClassificationText(),structure,fn));
}
