    ...
    if (psgeoGeolocationButton === undefined) {
        ...
        function geolocationAchieved(position) {
            ...
            if (myPosition.speed !== null && myPosition.speed > 0 && myPosition.heading !== null && myPosition.alt !== null) { 
                ...
                positionText += lib.htmlBreak() + "&rarr; " + lib.round(myPosition.heading,0) + "&deg; Speed: " + lib.round(3.6 * myPosition.speed,1) + " km/h";
            }
...
function psgeoAboutMenuBringUp(db,lib,lang,map) {
    if (psgeoAboutWindow === undefined) {
        ...
        var texts = [
            ...
            lang.getTextWithValues("credits",psgeoSmallDisplayMode,["v1.8.4","2023",]),
        ];
