...
function psgeoInitFilterPaneText(db,lib,lang,map,div,smallPane) {
    ...
    if (psgeoDomainDefault.cavemaps) {
        ...
        psgeoCreateCaveSizeCheckbox(db,
                                    ...
                                    lang.getTextWithValues("bigCaves",psgeoSmallDisplayMode,[psgeoCaveSizeBig]),
        ...
        psgeoCreateCaveSizeCheckbox(db,
                                    ...
                                    lang.getTextWithValues("mediumCaves",psgeoSmallDisplayMode,[psgeoCaveSizeSmall,psgeoCaveSizeBig]),
                                    !psgeoSmallDisplayMode)
        psgeoCreateCaveSizeCheckbox(db,
                                    lang,
                                    document,
                                    ...
                                    lang.getTextWithValues("cavelets",psgeoSmallDisplayMode,[psgeoCaveSizeSmall]),
                                    true)
...
function psgeoGetSubtypeGroupCheckboxList(lib,lang,group,structure) {
    ...
    for (var k = 0; k < group.extraSubActivitiesBefore.length; k++) {
        ...
        // var name = lang[group.subActivityCollection](subact.toLowerCase());
        // var name = lang[getTextCollectionItem](group.subActivityCollection,subact.toLowerCase()); // getTextCollectionItem NOT DEFINED
