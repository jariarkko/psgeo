...
const psgeoUpdateCaveLink="https://luolaseura.fi/luolan-tietojen-paivitys/";
...
var psgeoOtherTools = [
    ...
    },
    {
        ...
        nameFunction: "nimisampoToolNameText",
        descriptionTextFunction: "nimisampoToolDescriptionText"
    }
];
...
function psgeoMoreMenuContents(db,lib,lang,map,subdiv) {
    if (psgeoDomainDefault.luolaseura) {
        ...
        psgeoCaveUpdateMenuButton =
            psgeoGetCaveUpdateMenuButton(lang,
                                      subdiv,
                                      function() {
	                                  psgeoDebug("Cave add button pressed!");
                                          psgeoCaveUpdateBringUp(db,lib,lang,map);
                                      });
...
// *BringUp functions (functions that open websites or dialogs), called from buttons.
...
function psgeoCaveUpdateBringUp(db,lib,lang,map) {
	window.open(psgeoUpdateCaveLink, '_blank');
}
...
function psgeoGetCaveUpdateMenuButton(lang,structure,fn) {
    var icon = psgeoDomainDefault.icons.imgCaveAdd;
    if ( icon === undefined ) { icon=""; }
    return(psgeoGenericMenuButton(lang,
                                  icon,
