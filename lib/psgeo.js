...
function psgeoCreateOnlyFinlandFilter(db,lib,lang,map) {
    ...
    if (psgeoOnlyFinlandFilterCheckbox === undefined && psgeoOtherCountryFilterCheckbox === undefined) {
        return(undefined);
    } else if (psgeoOnlyFinlandFilterCheckbox !== undefined && psgeoOtherCountryFilterCheckbox === undefined) {
...
function psgeoFilterMenuContents(db,lib,lang,map,subdiv) {
    ...
    if (psgeoDomainDefault.nameSearch) {
        psgeoFilterSectionPrefix(lang,lang.getText("name",psgeoSmallDisplayMode),subdiv); // Name search box has header "Name"
...
function psgeoGetOtherCountryCheckbox(lib,lang,structure) {
    return(psgeoGetGenericCheckbox("other countries",lang.getText("otherCountries"),structure,true,true));
}
