...
function psgeoInitMapFinnishTerrain(lang,apiKey,cfg) {
    return(new google.maps.ImageMapType({
        getTileUrl: function(coord, zoom) {
            return(cfg.psgeoFinnishTerrainMapBaseurl +
                   zoom +
                   "/" + 
                   coord.y +
                   "/" +
...
async function psgeoInitSettings() {
...
function psgeoInitMap(lib,db,cfg,tbl,psgeoDomainDefault,queryString, urlParams,pathname,hostname) {
    ...
    //
    // Onboard the Finnish topographic map
    //
    if (psgeoDomainDefault.finnishTerrain) {
        let apiKey = psgeoDomainDefault.finnishTerrainApiKey;
        $.psgeoMapFinnish = psgeoInitMapFinnishTerrain(lang,apiKey,cfg);
