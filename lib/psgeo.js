...
function psgeoInitDomain(hostname) {
    var i;
    for (i = 0; i < psgeoDomainDefaults.length; i++) {
        var candidateDomainDefault = psgeoDomainDefaults[i];
        var j;
        for (j = 0; j < candidateDomainDefault.domains.length; j++) {
            var domain = candidateDomainDefault.domains[j];
