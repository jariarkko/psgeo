...
function PsgeoLib() {
    ...
    function getSwimmingOtherPlaceSubActivities() {
        var result = ["Outdoor",
                      "Indoor",
                      "Underground",
                      "Beach",
    ...
    function getSwimmingPlaceSubActivities(includeUnknown = false) {
        ...
        result = result.concat(getSwimmingOtherPlaceSubActivities());
        return(result);
    }
    
    function getSwimmingMaterialSubActivities() {
        var result = ["Water",
                      "Ice",
                      "Balls"];
        return(result);
    ...
    function getClimbingTypeSubActivities() {
        var result = ["Mountain",
                      "Rock",
                      "Ice",
                      "Wall",
    ...
    function getSkiingSubstanceSubActivities(includeUnknown = false) {
        var result = ["Snow",
                      ...
                      "Other-Substances",
                      "Imported-Snow"];
        if (includeUnknown) result.push("Unknown-Substance");
        return(result);
    }

    function getSkiingPlaceSubActivities() {
        var result = ["Indoor",
                      "Outdoor",
                      "Underground"];
        return(result);
    ...
    function getSkiingUphillSubActivities(includeUnknown = false) {
        var result = ["Lifts",
                      ...
                      "Dogs",
                      "Other-Uphill"];
        if (includeUnknown) result.push("Unknown-Uphill");
        return(result);
    }
    ...
    function getBikingBikeTrackSubActivities() {
        var result = [
            "Track-City",
            "Track-Road",
            "Track-Trail",
    ...
    function getBikingBikeTypeSubActivities() {
        var result = [
            "Bike-City",
            "Bike-Road",
            "Bike-Mountain",
    ...
    function getSaunaSaunaTypeSubActivities(includeUnknown = false) {
        var result = [
            "Normal",
            "Smoke",
            "Steam",
    ...
    return({
        ...
        getSaunaSaunaTypeSubActivities: getSaunaSaunaTypeSubActivities,
