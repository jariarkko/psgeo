...
<<<<<<< HEAD
        case 'Urbanex': return getDefaultUrbanex(db);
        case 'Climbing': return getDefaultClimbing(db);
        case 'Biking': return getDefaultBiking(db);
        case 'Swimming': return getDefaultSwimming(db);
        case 'Flying': return getDefaultFlying(db);
        case 'Sauna': return getDefaultSauna(db);
=======
...
>>>>>>> testing
    ...
    function numberWithSpaces(x,language) {
