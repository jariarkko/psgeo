...
function PsgeoLib() {
    ...
    function getDefaultFilter(db,activity) {
        ...
        case 'CavingFinland': return getDefaultCavingFinland(db); 
        case 'CavingMap': return getDefaultFilterCavingMap(db);         
        case 'CavingMapFinland': return getDefaultFilterCavingMapFinland(db);
