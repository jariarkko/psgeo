...
function PsgeoLib() {
    ...
    function isHidden(element) {
        // Works for everything but <html>, <body>, and elements with position: fixed
        // Reference: https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/offsetParent
        return (element.offsetParent === null)
        // Fixed position elements would be detected/avoided by the MUCH SLOWER
