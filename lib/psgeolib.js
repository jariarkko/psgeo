...
function PsgeoLib() {
    ...
    function getDefaultFilter(db,activity) {
        ...
        case 'CavingFinland': return getDefaultCavingFinland(db); // Needed? XXXXX
        case 'CavingMap': return getDefaultCavingMap(db);         // Needed? XXXXX
        case 'CavingMapFinland': return getDefaultCavingMapFinland(db); // Needed? XXXXX
