...
function PsgeoDBText(lib) {
    ...
    function describeItem(db,
        ...
        if (!db.getItemFuzzy(item) && typeof myPosition !== 'undefined' ) {
            ...
            if (conserveSpace) {
            html += lib.htmlBreak() + lang.getText("targetDistance") + ': ' + distance + ' m. ' + lang.getText("targetBearing") + ': ' + bearing + ' ' + lang.getText("degrees") + '.';
            } else {
            html += lib.htmlParagraph(lang.getText("targetDistance") + ': ' + distance + ' m. ' + lang.getText("targetBearing") + ': ' + bearing + ' ' + lang.getText("degrees") + '.');
            }
