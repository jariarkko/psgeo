...
function PsgeoLang(language) {
    ...
    addTranslation("addCave", { en: "add a cave", fi: "lisää luola", sv: "lägg till en grotta" });
    addTranslation("addCaveShort", { en: "add", fi: "lisää", sv: "lägg till" });
    addTranslation("modifyCave", { en: "suggest a correction", fi: "kerro korjaustarpeesta", sv: "ge nya uppgifter" });
    addTranslation("modifyCaveShort", { en: "correct", fi: "päivitä", sv: "uppdatera" });
    ...
    addTranslation("myGeolocation", { en: "Your position", fi: "Paikannettu sijainti", sv: "Position" });
