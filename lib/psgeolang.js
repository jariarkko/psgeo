...
function PsgeoLang(language) {
    ...
    addTranslation("trackDisplay", { en: "Display position using", fi: "Sijainnin näyttötapa", sv: "Visa position med" });
    addTranslation("showPositionMarker", { en: "Values", fi: "Lukuarvot", sv: "Värden" });
