...
function PsgeoLang(language) {
    ...
    dataDistinctExplanationTexts["fi"] =
        "Psgeo on pelkkä ohjelmistokirjasto, eikä sinänsä liity mitenkään tietoihin joita sen avulla esitetään. Psgeo:n ohjelmiston kirjoittajat eivät ole mitenkään vastuussa tiedosta, jota kirjastolla esitetään.";
    ...
    nimisampoToolDescriptionTexts["en"] =
        "Nimisampo is a tool for place name research. It it meant both for academia and the general public.";
    nimisampoToolDescriptionTexts["fi"] =
        "Nimisampo on kaikille avoin verkkopalvelu suomalaisesta paikannimistöstä kiinnostuneiden tutkijoiden ja suuren yleisön käytettäväksi.";
