...
function PsgeoLang(language) {
    ...
    addTranslation("rangeMedium", { en: "length {{string1}}..{{string2}}m", fi: "pituus {{string1}}..{{string2}}m", sv: "längd {{string1}}..{{string2}}m" });
    addTranslation("rangeMediumShort", { en: "{{string1}}..{{string2}}m", sv: "{{string1}}..{{string2}}m", fi: "{{string1}}..{{string2}}m" });
    addTranslation("rangeLow", { en: "length under {{string1}} m", fi: "pituus alle {{string1}} m", sv: "längd under {{string1}} m" });
    addTranslation("rangeLowShort", { en: "<{{string1}}m", sv: "<{{string1}}m", fi: "<{{string1}}m" });
    addTranslation("rangeHigh", { en: "length over {{string1}} m", fi: "pituus yli {{string1}} m", sv: "längd över {{string1}} m" });
    addTranslation("rangeHighShort", { en: ">{{string1}}m", sv: ">{{string1}}m", fi: ">{{string1}}m" });
