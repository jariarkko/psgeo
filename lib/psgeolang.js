...
function PsgeoLang(language) {
    ...
    libraryExplanationTexts["fi"] =
        'Palvelin ajaa <a href="https://github.com/jariarkko/psgeo" target="_blank">Psgeo</a>-ohjelmistoa, jolla voidaan esittää aktiviteetteja ja harrastuspaikkoja kartalla. Ohjelmisto on avointa lähdekoodia, ja mahdollistaa tiedon filtteröinnin pohjauten alla olevaan <a href="https://github.com/jariarkko/psgeo/blob/master/doc/activity-json.txt" target="_blank">semanttiseen tietoon</a> paikoista, aktiviteeteista, ja artikkeleista jotka kuvaavat niitä.';
    ...
    dangerousExplanationTexts["en"] =
        "Also, neither the software authors or data providers are responsible for possible accidents resulting in attempting to go there. YOU HAVE BEEN WARNED! MOST LOCATIONS SHOWN WITH THIS TOOL ARE DANGEROUS!";
    dangerousExplanationTexts["fi"] =
        "Ohjelmiston kirjoittajat tai sillä esitettävän tiedon kerääjät eivät myöskään ole vastuussa onnettomuksista joita saattaa sattua, mikäli esitetyissä kohteissa vieraillaan. SINUA ON VAROITETTU, NÄYTETTÄVÄT PAIKAT OVAT YLEENSÄ VAARALLISIA!";
