...
function PsgeoLang(language) {
	...
	// Deprecated. Every *Texts can now be normal *Texts or *TextsShort
...
// <--- TEMPORARY
    ...
    function genText(tab) {
        if (typeof tab[language] !== "string") {
            ...
            // language = "en";		// NOTE: one missing translation would cause a global(!) language change.
            return(tab["en"]);
        }
        return(tab[language])
    }
...
// ********************************
 ...
 // **********************************************
	...
	function getTextCollectionItem(controlledVocabulary,tagText) {
		...
		// Caves exist in rock, ice, moraine and turf, at least.
