...
function PsgeoLang(language) {
    ...
    addTranslation("positionMarkerOnly", { en: "Values", fi: "Lukuarvot", sv: "Värden" });
    addTranslation("traceOnly", { en: "Track", fi: "Jälki", sv: "Spår" });
    addTranslation("positionMarkerAndTrace", { en: "Both", fi: "Molemmat", sv: "Båda" });
