...
function PsgeoLang(language) {
    ...
    // addTranslation("targetDistance", { en: "Distance", fi: "Etäisyys", sv: "Avstånd" });
    // addTranslation("targetBearing", { en: "Bearing", fi: "Suuntima", sv: "Bäring" });
    // addTranslation("degrees", { en: "degrees", fi: "astetta", sv: "grader" });
    addTranslation("height", { en: "Z=", fi: "Z=", sv: "Z=" });
