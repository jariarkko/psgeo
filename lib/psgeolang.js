...
function PsgeoLang(language) {
    ...
    addTranslation("add", { en: "add", fi: "lisää", se: "visa mera", se: "lägg till" });
    addTranslation("orModify", { en: "or modify", fi: "tai korjaa", se: "eller uppdatera" });
    ...
    addVocabularyItem(v,"morphology-boulders", { en: "boulder", fi: "lohkare", se: "block-" });
    addVocabularyItem(v,"morphology-crack", { en: "crevice", fi: "rako", se: "sprick-" });
    addVocabularyItem(v,"morphology-crystallization", { en: "blister", fi: "kideonkalo", se: "kavitet med kristaller" });
    addVocabularyItem(v,"morphology-erosion", { en: "erosion", fi: "eroosio", se: "erosions-" });
    ...
    addVocabularyItem(v,"morphology-weathering", { en: "weathering", fi: "rapautumis", se: "förvittrings-" });
    ...
    addVocabularyItem(v,"waterbody-pool", { en: "in a swimming pool", fi: "uimaaltaassa", se: "i simbassäng" });
