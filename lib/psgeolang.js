...
function PsgeoLang(language) {
    ...
    addTranslation("articles", { en: "articles", fi: "artikkeleita", sv: "artiklar" });
    ...
    addTranslation("length", { en: "length", fi: "pituus", sv: "längd" }); // used as {{string1}} below
    addTranslation("height", { en: "height", fi: "korkeus", sv: "höjd" }); // used as {{string1}} below
    addTranslation("altitude", { en: "altitude", fi: "korkeus", sv: "höjd" }); // used as {{string1}} below
    addTranslation("depth", { en: "depth", fi: "syvyys", sv: "djup" }); // used as {{string1}} below
    addTranslation("grade", { en: "grade", fi: "greidi", sv: "grad" }); // used as {{string1}} below
    addTranslation("time", { en: "time", fi: "kesto", sv: "tid" }); // used as {{string1}} below
    addTranslation("temperature", { en: "temperature", fi: "lämpötila", sv: "värme" }); // used as {{string1}} below
    addTranslation("meters", { en: "m", fi: "m", sv: "m" }); // used as {{string1}} below
    addTranslation("kilometers", { en: "km", fi: "km", sv: "km" }); // used as {{string1}} below
    addTranslation("minutes", { en: "min", fi: "min", sv: "min" }); // used as {{string1}} below
    addTranslation("hours", { en: "hr", fi: "t", sv: "timmar" }); // used as {{string1}} below
    addTranslation("days", { en: "d", fi: "pv", sv: "dagar" }); // used as {{string1}} below
    addTranslation("celcius", { en: "C", fi: "C", sv: "CC" }); // used as {{string1}} below


    addTranslation("rangeMedium", { en: "{{string1}} {{string2}}..{{string3}}{{string4}}", fi: "{{string1}} {{string2}}..{{string3}}{{string4}}", sv: "{{string1}} {{string2}}..{{string3}}{{string4}}" });
    addTranslation("rangeMediumShort", { en: "{{string2}}..{{string3}}{{string4}}", sv: "{{string2}}..{{string3}}{{string4}}", fi: "{{string2}}..{{string3}}{{string4}}" });
    // addTranslation("rangeLow", { en: "{{string1}} < {{string2}}{{string3}}", fi: "{{string1}} < {{string2}}{{string3}}", sv: "{{string1}} < {{string2}}{{string3}}" });
    addTranslation("rangeLow", { en: "{{string1}} < <div id=\"xyz\">{{string2}}{{string3}}<\/div>", fi: "{{string1}} < {{string2}}{{string3}}", sv: "{{string1}} < {{string2}}{{string3}}" });
    addTranslation("rangeLowShort", { en: "< {{string2}}{{string3}}", sv: "< {{string2}}{{string3}}", fi: "< {{string2}}{{string3}}" });
    addTranslation("rangeHigh", { en: "{{string1}} > {{string2}}{{string3}}", fi: "{{string1}} > {{string2}}{{string3}}", sv: "{{string1}} > {{string2}}{{string3}}}" });
    addTranslation("rangeHighShort", { en: "> {{string2}}{{string3}}", sv: "> {{string2}}{{string3}}", fi: "> {{string2}}{{string3}}" });
    // End of range filter translations
    ...
    // Subtypes
    addTranslation("invertSelection", { en: "invert selection", fi: "käännä valinnat", sv: "invertera val" });
    addTranslation("invertSelectionShort", { en: "invert", fi: "käännä", sv: "invert" });
    addTranslation("clearSelection", { en: "clear selection", fi: "tyhjennä valinnat", sv: "töm val" });
    addTranslation("clearSelectionShort", { en: "invert", fi: "tyhjennä", sv: "töm" });
    ...
    addTranslation("withMapShort", { en: "", fi: "", sv: "" });
