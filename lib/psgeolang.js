...
function PsgeoLang(language) {
    ...
    addTranslation("close", { en: "close", fi: "sulje", sv: "stäng" });
    ...
    addTranslation("height", { en: "height", fi: "korkeus", sv: "höjd" });
    addTranslation("altitude", { en: "altitude", fi: "korkeus", sv: "höjd" });
    addTranslation("depth", { en: "depth", fi: "syvyys", sv: "djup" });
    addTranslation("grade", { en: "grade", fi: "greidi", sv: "grad" });
    addTranslation("time", { en: "time", fi: "kesto", sv: "tid" });
    addTranslation("temperature", { en: "temperature", fi: "lämpötila", sv: "värme" });
    addTranslation("meters", { en: "m", fi: "m", sv: "m" });
    addTranslation("kilometers", { en: "km", fi: "km", sv: "km" });
    addTranslation("minutes", { en: "min", fi: "min", sv: "min" });
    addTranslation("hours", { en: "hr", fi: "t", sv: "timmar" });
    addTranslation("days", { en: "d", fi: "pv", sv: "dagar" });
    addTranslation("celcius", { en: "C", fi: "C", sv: "CC" });
    // The text below is combines with some range filter text above
    addTranslation("rangeCategoryLimits", { en: " class limits", fi: "luokkien rajat", sv: "klass gränser" });
