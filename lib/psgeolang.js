...
function PsgeoLang(language) {
    ...
    addTranslation("rangeMediumShort", { en: "{{string1}}..{{string2}}{{string3}}", sv: "{{string1}}..{{string2}}{{string3}}", fi: "{{string1}}..{{string2}}{{string3}}" });
    addTranslation("rangeLow", { en: "{{string1}} < {{string2}}{{string3}}", fi: "{{string1}} < {{string2}}{{string3}}", sv: "{{string1}} < {{string2}}{{string3}}" });
    addTranslation("rangeLowShort", { en: "< {{string1}}{{string2}}", sv: "< {{string1}}{{string2}}", fi: "< {{string1}}{{string2}}" });
    addTranslation("rangeHigh", { en: "{{string1}} > {{string2}}{{string3}}", fi: "{{string1}} > {{string2}}{{string3}}", sv: "{{string1}} > {{string2}}{{string3}}}" });
    addTranslation("rangeHighShort", { en: "> {{string1}}{{string2}}", sv: "> {{string1}}{{string2}}", fi: "> {{string1}}{{string2}}" });
