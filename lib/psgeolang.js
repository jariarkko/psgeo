...
function PsgeoLang(language) {
    ...
    addTranslation("decimalSeparator",
        {
                en: ".",    // Dot
                fi: ",",    // Comma
                sv: ","    // Comma
    ...
    addTranslation("Planetskier",
        {
                en: "Planetskier blog",
                fi: "Planetskier-blogi",
                sv: "Planetskier blogg"
        });
    ...
    addTranslation("TheUrbanExplorer",
        {
                en: "UrbanExplorer blog",
                fi: "UrbanExplorer-blogi",
                sv: "UrbanExplorer blogg"
        });
    addTranslation("Planetclimber",
        {
                en: "Planetclimber blog",
                fi: "Planetclimber-blogi",
                sv: "Planetclimber blogg"
        });
    addTranslation("Planetbiker",
        {
                en: "Planetbiker blog",
                fi: "Planetbiker-blogi",
                sv: "Planetbiker blogg"
        });
    addTranslation("Planetflier",
        {
                en: "Planetflier blog",
                fi: "Planetfiler-blogi",
                sv: "Planetflier blogg"
        });
    addTranslation("Saunablogger",
        {
                en: "Saunablogger blog",
                fi: "Saunablogger-blogi",
                sv: "Saunablogger blogg"
        });
    ...
    addTranslation("caveMap",
        {
                en: "cave map",
                fi: "luolakartta",
                sv: "grottkarta"
        });
    addTranslation("caveModel",
        {
                en: "3D cave model",
                fi: "3D-luolamalli",
                sv: "3D-grottmodell"
        });
    addTranslation("caves",
        {
                en: "caves",
                fi: "luolaa",
                sv: "grottor"
    ...
    // Range filter texts
    //     e.g. Length 5..50m, Grade < 6, Depth > 30 etc.
    ...
    addTranslation("height",
        {
                en: "height",
                fi: "korkeus",
                sv: "höjd"
        });
    addTranslation("altitude",
        {
                en: "altitude",
                fi: "korkeus",
                sv: "höjd"
        });
    addTranslation("depth",
        {
                en: "depth",
                fi: "syvyys",
                sv: "djup"
        });
    addTranslation("grade",
        {
                en: "grade",
                fi: "greidi",
                sv: "grad"
    ...
    addTranslation("temperature",
        {
                en: "temperature",
                fi: "lämpötila",
                sv: "värme"
        });
    addTranslation("meters",
        {
                en: "m",
                fi: "m",
                sv: "m"
        });
    addTranslation("kilometers",
        {
                en: "km",
                fi: "km",
                sv: "km"
        });
    addTranslation("minutes",
        {
                en: "min",
                fi: "min",
                sv: "min"
        });
    addTranslation("hours",
        {
                en: "hr",
                fi: "t",
                sv: "timmar"
    ...
    addTranslation("celcius",
        {
                en: "C",
                fi: "C",
                sv: "C"
        });
    // The text below is combined with some range filter text above
    addTranslation("rangeCategoryLimits",
        {
                en: " class limits",
                fi: "luokkien rajat",
                sv: "klass gränser"
        });
    addTranslation("dimensions",
        {
                en: "dimensions",
                fi: "mitat",
                sv: "mått"
        });
    addTranslation("literatureCaveId",
        {
                en: "The Finnish identification code for this cave is",
                fi: "Suomalainen luolakoodi luolalle on",
                sv: "Finskt grottindex för grottan är"
        });
    addTranslation("lengthCategory",
        {
                en: "length category",
                fi: "pituusluokka",
                sv: "längdklass"
        });
    // Subtype checkbox control buttons
    addTranslation("invertSelection", { en: "invert", fi: "käännä", sv: "invertera" });
    addTranslation("invertSelectionShort", { en: "invert", fi: "käännä", sv: "invert" });
    addTranslation("clearSelection", { en: "clear", fi: "tyhjennä", sv: "töm" });
    addTranslation("clearSelectionShort", { en: "clear", fi: "tyhjennä", sv: "töm" });
    addTranslation("showRangeTools", { en: "range", fi: "mitta", sv: "mått" });
    addTranslation("showRangeToolsShort", { en: "range", fi: "mitta", sv: "mått" });
    addTranslation("showSubtypeGroups", { en: "type", fi: "tyyppi", sv: "typ" });
    addTranslation("showSubtypeGroupsShort", { en: "type", fi: "tyyppi", sv: "typ" });
    addTranslation("showMoreTools", { en: "more", fi: "lisää", sv: "övrigt" });
    // Subtypes
    ...
    addTranslation("Biking", { en: "Biking", fi: "Pyörä", sv: "Cykel" });
    addTranslation("Cave", { en: "Cave", fi: "Luola", sv: "Grotta" });
    addTranslation("Climb", { en: "Climb", fi: "Kiipeily", sv: "Klättring" });
    addTranslation("Sauna", { en: "Sauna", fi: "Sauna", sv: "Sauna" });
    addTranslation("Ski", { en: "Ski", fi: "Hiihto", sv: "Skidning" });
    addTranslation("Snowboard", { en: "Snowboard", fi: "Lumilauta", sv: "Snowboard" });
    addTranslation("Swim", { en: "Swim", fi: "Uinti", sv: "Simning" });
    addTranslation("Dive", { en: "Dive", fi: "Sukellus", sv: "Dykeri" });
    addTranslation("Urbanex", { en: "Urbanex", fi: "Urbanex", sv: "Urbanex" });
    addTranslation("Other", { en: "Other", fi: "Muut", sv: "Övriga" });
    // Misc
    ...
    addTranslation("cave", { en: "cave", fi: "luola", sv: "grotta" });
    addTranslation("caveMaps", { en: "maps", fi: "karttaa", sv: "kartor" });
    addTranslation("models3D", { en: "3D models", fi: "3D-mallia", sv: "3D-modeller" });
    addTranslation("withMap", { en: "surveyed", fi: "kartoitetut", sv: "karterade" });
    addTranslation("withMapShort", { en: "map", fi: "kartta", sv: "karta" });
    addTranslation("withModel", { en: "3D-model", fi: "3D-malli", sv: "3D-modell" });
    addTranslation("withModelShort", { en: "3D-model", fi: "3D-malli", sv: "3D-modell" });
    addTranslation("withVideo", { en: "Video", fi: "Video", sv: "Video" });
    addTranslation("withVideoShort", { en: "Video", fi: "Video", sv: "Video" });
    addTranslation("source", { en: "source", fi: "lähde", sv: "källa" });
    addTranslation("sources", { en: "sources", fi: "lähteet", sv: "källor" });
    // Filter
    addTranslation("require", { en: "require", fi: "vaadi", sv: "kräv" });
    addTranslation("requireShort", { en: "require", fi: "vaadi", sv: "kräv" });
    ...
    addTranslation("onlyHomecountry", { en: "Home country", fi: "Kotimaa", sv: "Hemlandet" });
    addTranslation("otherCountries", { en: "other countries", fi: "ulkomaat", sv: "övriga länder" });
    addTranslation("Finland", { en: "Finland", fi: "Suomi", sv: "Finland" });
    addTranslation("Sweden", { en: "Sweden", fi: "Ruotsi", sv: "Sverige" });
    addTranslation("United Kingdom", { en: "United Kingdom", fi: "Yhdistyneet Kuningaskunnat", sv: "Storbritannien och Norra Irland" });
    addTranslation("France", { en: "France", fi: "Ranska", sv: "Frankrike" });
    // Topographic maps
    addTranslation("seaChartsFinland", { en: "Finnish marine charts", fi: "Suomen merikortit", sv: "Finska sjökort" });
    addTranslation("topoMapsFinland", { en: "Finnish terrain", fi: "Suomen maasto", sv: "Finsk topografkarta" });
    addTranslation("topoMapsFinlandShort", { en: "Finland", fi: "Suomi", sv: "Finland" });
    addTranslation("topoMapsSweden", { en: "Swedish terrain", fi: "Ruotsin maasto", sv: "Svensk topografkarta" });
    addTranslation("topoMapsSwedenShort", { en: "Sweden", fi: "Ruotsi", sv: "Sverige" });
    addTranslation("topoMapsNorway", { en: "Norwegian terrain", fi: "Norjan maasto", sv: "Norsk topografkarta" });
    addTranslation("topoMapsNorwayShort", { en: "Norway", fi: "Norja", sv: "Norge" });
    addTranslation("topoMapsUK", { en: "UK terrain", fi: "UK maasto", sv: "UK topografkarta"});
    addTranslation("topoMapsUKShort", { en: "UK", fi: "UK", sv: "UK" });
    addTranslation("openTopo", { en: "Opentopo terrain", fi: "Opentopo maasto", sv: "Opentopo terräng"});
    addTranslation("openTopoShort", { en: "Opentopo", fi: "Opentopo", sv: "Opentopo" });
    // Misc
    ...
    addTranslation("task", { en: "task", fi: "toiminto", sv: "i aktivitet" });
    ...
    addTranslation("geolocationYouAreHere", { en: "Your position", fi: "Paikannettu sijainti", sv: "Din position" });
    addTranslation("geolocationPermissionDenied", { en: "Geolocation request denied by user.", fi: "Et antanut paikannuslupaa.", sv: "Du gav inte tillgång till position." });
    addTranslation("geolocationUnavailable", { en: "Location information is unavailable.", fi: "Paikannus ei ole saatavilla.", sv: "Positionsbestämmning inte återkomlig." });
    addTranslation("geolocationRequestTimeout", { en: "Position request timed out.", fi: "Paikannus kestää liian pitkään.", sv: "Positionsbestämmningen tar för länge." });
    addTranslation("geolocationUnknownError", { en: "Unknown error.", fi: "Paikannus epäonnistui tuntemattomasta syystä.", sv: "Kunde inte finna position av okänd orsak." });
    ...
    addTranslation("distanceAndBearing", { en: "Distance: {{string1}} {{string2}}. Bearing: {{string3}} degrees.", fi: "Etäisyys: {{string1}} {{string2}}. Suuntima: {{string3}} astetta.", sv: "Avstånd: {{string1}} {{string2}}. Bäring: {{string3}} grader."});
    addTranslation("altitudeInfo", { en: "Alt: {{string1}} m (WGS84)", fi: "Alt: {{string1}} m (WGS84)", sv: "Alt: {{string1}} m (WGS84)"});
    addTranslation("accuracyInfo", { en: "Acc: {{string1}} m", fi: "Virhe: {{string1}} m", sv: "Fel: {{string1}} m"});
    addTranslation("aboveEllipsoid", { en: "(WGS84).", fi: "(WGS84).", sv: "(WGS84)." });
    addTranslation("Speed", { en: "Speed", fi: "Nopeus", sv: "Hastighet" });
    addTranslation("gpxmenu", { en: "GPX menu", fi: "GPX menu", sv: "GPX menu" });
    addTranslation("downloadGPX", { en: "Export GPX files", fi: "Tallenna GPX-tiedostoja", sv: "Spara GPX-filer" });
    addTranslation("trackDisplay", { en: "Location display", fi: "Sijainnin näyttötapa", sv: "Positionens visningsstil" });
    addTranslation("showPositionMarker", { en: "Info bubble", fi: "Infokupla", sv: "Info bubbla" });
    addTranslation("showTrack", { en: "Track", fi: "Jälki", sv: "Spår" });
    addTranslation("showPositionMarkerAndTrack", { en: "Both", fi: "Molemmat", sv: "Båda" });
    addTranslation("noRecordedTracks", { en: "No track records", fi: "Ei tallennettuja reittejä", sv: "Inga sparade spår" });
    addTranslation("richPositionInfo", { en: "Display coordinates, speed and bearing.", fi: "Näytä koordinaatit, nopeus ja suunta.", sv: "Visa koordinater, hastighet och bäring." });
    addTranslation("recordRoute", { en: "Record route.", fi: "Tallenna kuljettu reitti.", sv: "Spara rutten." });
    addTranslation("requireStablePosition", { en: "Require stable position.", fi: "Odota sijainnin stabiloitumista.", sv: "Vänta att positionen stabiliseras." });
    addTranslation("measureDistanceButton", { en: "Measure distance", fi: "Mittaa matka", sv: "Mät avståndet" });
    addTranslation("measureDistanceFirst", { en: "Click or tap the map to set the starting point", fi: "Napsauta tai napauta karttaa asettaaksesi aloituspisteen", sv: "Klicka eller tryck på kartan för att ställa in startpunkten" });
    addTranslation("measureDistanceLenght", { en: "Distance", fi: "Matka", sv: "Distans" });
    addTranslation("measureDistanceEnd", { en: "Stop measuring", fi: "Lopeta mittaaminen", sv: "Sluta mäta" });
    ...
    addVocabularyItem(v,"rock-granite", { en: "non-volcanic, non-sedimentary", fi: "kivi, ei vulkaaninen, ei sedimentti", sv: "annan sten än vulkaniskt eller sediment" });
    ...
    //
    // Diving environment vocabulary --------------------------------------------------------------
    //

    v = addVocabulary("divingEnvironment");
    ...
    addVocabularyItem(v,"divingenvironment-sump", { en: "in a sump", fi: "kuivaluolan vedenalaisessa osassa", sv: "i sifon" });
    addVocabularyItem(v,"divingenvironment-cave", { en: "in a cave", fi: "luolassa", sv: "i en grotta" });
    addVocabularyItem(v,"divingenvironment-mine", { en: "in a mine", fi: "kaivoksessa", sv: "i en gruva" });
    addVocabularyItem(v,"divingenvironment-ice", { en: "under ice", fi: "avannossa", sv: "i en vak" });
    addVocabularyItem(v,"divingenvironment-stonequarry", { en: "in a stonequarry", fi: "kivilouhoksessa", sv: "i ett stenbrott" });
    addVocabularyItem(v,"divingenvironment-sandpit", { en: "in a sandpit", fi: "hiekkakuopassa", sv: "i ett sandtag" });
    addVocabularyItem(v,"divingenvironment-industrial", { en: "in industrial setting", fi: "teollisuuslaitoksessa", sv: "i ett industriellt ställe" });
    addVocabularyItem(v,"divingenvironment-harbour", { en: "in a harbour", fi: "satamassa", sv: "i ett hamn" });
    addVocabularyItem(v,"divingenvironment-sea", { en: "in the sea", fi: "meressä", sv: "i sjön" });
    addVocabularyItem(v,"divingenvironment-river", { en: "in a river", fi: "joessa", sv: "i en å, flod eller älv" });
    addVocabularyItem(v,"divingenvironment-lake", { en: "in a lake", fi: "järvessä", sv: "i en sjö" });
    addVocabularyItem(v,"divingenvironment-spring", { en: "in a spring", fi: "lähteessä", sv: "i en källä" });
    addVocabularyItem(v,"divingenvironment-pool", { en: "in a swimming pool", fi: "uima-altaassa", sv: "i simbassäng" });
    addVocabularyItem(v,"divingenvironment-other", { en: "in some other body of water", fi: "jossain muussa vesialtaassa", sv: "i något annat vattendrag" });
    addVocabularyItem(v,"divingenvironment-unknown", { en: "in an unknown waterbody", fi: "ei tiedossa olevassa vesialtaassa", sv: "i ett okänt vattendrag" });

    //
    // Diving environment vocabulary --------------------------------------------------------------
    //

    v = addVocabulary("divingTask");
    addVocabularyItem(v,"divingtask-recreationalopenwater", { en: "basic openwater", fi: "perus avovesi", sv: "vanligt öppet vatten" });

    addVocabularyItem(v,"divingtask-ice", { en: "ice", fi: "jää", sv: "is" });
    addVocabularyItem(v,"divingtask-mine", { en: "mine", fi: "kaivos", sv: "gruvdykning" });
    addVocabularyItem(v,"divingtask-cave", { en: "cave", fi: "luola", sv: "grottdykning" });
    addVocabularyItem(v,"divingtask-sump", { en: "sump", fi: "speleologinen", sv: "sifon" });
    addVocabularyItem(v,"divingtask-wreck", { en: "wreck", fi: "hylky", sv: "vrak" });
    addVocabularyItem(v,"divingtask-wreckpenetration", { en: "wreck penetration", fi: "hylkypenetraatio", sv: "vrakpenetration" });
    addVocabularyItem(v,"divingtask-underwaterstructurepenetration", { en: "underwater structure penetration", fi: "vedenalaisiin rakenteisiin sukeltaminen", sv: "dykning in undervattenkonstruktioner" });
    addVocabularyItem(v,"divingtask-photovideo", { en: "photo and video", fi: "vedenalaiskuvaus", sv: "fotografi eller video" });
    addVocabularyItem(v,"divingtask-fishinghunting", { en: "fishing/hunting", fi: "kalastus/ravustus", sv: "fiske o.dyl." });
    addVocabularyItem(v,"divingtask-guidingandinstruction", { en: "guiding or instruction", fi: "opastus tai koulutus", sv: "guidning eller instruktion" });
    addVocabularyItem(v,"divingtask-biology", { en: "biology", fi: "biologia", sv: "biologi" });
    addVocabularyItem(v,"divingtask-archaeology", { en: "archaeology", fi: "arkeologia", sv: "arkeologi" });
    addVocabularyItem(v,"divingtask-installation", { en: "installtion", fi: "asennus", sv: "installation" });
    addVocabularyItem(v,"divingtask-inspectionrepair", { en: "inspection or repair", fi: "tarkastus tai korjaus", sv: "inspektion eller reparation" });
    addVocabularyItem(v,"divingtask-recovery", { en: "recovery or salvage", fi: "pintaan nosto", sv: "bärgning" });
    addVocabularyItem(v,"divingtask-rescue", { en: "rescue", fi: "pelastaminen", sv: "räddning" });
    addVocabularyItem(v,"diving-other", { en: "other", fi: "muu", sv: "övrigt" });
    addVocabularyItem(v,"unknown", { en: "unknown", fi: "tuntematon", sv: "okänt" });
