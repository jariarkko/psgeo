...
function PsgeoLang(language) {
    ...
    addVocabularyItem(v,"other-material", { en: "in some other place", fi: "jossain muussa paikassa", se: "i annat plats" });
    addVocabularyItem(v,"unknown-material", { en: "unknown place type", fi: "tuntemattomassa uimapaikkatyypissä", se: "annat simplats" });
    ...
    addVocabularyItem(v,"unknown-substance", { en: "on unknown substance", fi: "ei tiedossa olevalla materiaalilla", se: "på okänt material" });
    ...
    addVocabularyItem(v,"unknown-uphill", { en: "unknown method", fi: "ei tiedossa olevalla tavalla", se: "okänt sätt" });
