...
function PsgeoLang(language) {
    ...
    addTranslation("dangerousExplanationShort",
        {
            en: "LOCATIONS SHOWN CAN BE DANGEROUS! The website is not responsible for accidents.",
            fi: "NÄYTETTÄVÄT PAIKAT OVAT YLEENSÄ VAARALLISIA! Palvelu ei vastaa onnettomuuksista."
        });
