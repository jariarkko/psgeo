...
function PsgeoLang(language) {
    ...
    addTranslation("libraryExplanationShort",
        {
            en: 'The server is powered by <a href="https://github.com/jariarkko/psgeo" target="_blank">Psgeo</a>, an open source software.',
            fi: 'Palvelin käyttää <a href="https://github.com/jariarkko/psgeo" target="_blank">Psgeo</a>-ohjelmistoa.'
        });
    ...
    addTranslation("dangerousExplanationShort",
        {
            en: "LOCATIONS SHOWN CAN BE DANGEROUS! The website/developers are not responsible for any accidents.",
            fi: "NÄYTETTÄVÄT PAIKAT OVAT YLEENSÄ VAARALLISIA! Kehittäjät/palvelu eivät vastaa onnettomuuksista."
        });
    ...
    addTranslation("ruuthToolDescription",
        {
            en: "Historicf artefacts to caves or to occupation-era aearial maps. Find new caves!",
