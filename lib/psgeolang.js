...
function PsgeoLang(language) {
    ...
    var rockTypeTexts = [];
    rockTypeTexts["en"] = "rock type";
    rockTypeTexts["fi"] = "kivilaji";
    ...
    filterByRockTypeTexts["en"] = "filter by rock type";
    filterByRockTypeTexts["fi"] = "suodata kivilajin perusteella";
    ...
    filterByMorphologyTexts["en"] = "filter by morphology";
    filterByMorphologyTexts["fi"] = "suodata syntytavan perusteella";
