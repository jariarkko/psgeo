...
function PsgeoLang(language) {
    ...
    addTranslation("otherCountries", { en: "other", fi: "muu", se: "annat" });
    ...
    addVocabularyItem(v,"material-other", { en: "other material", fi: "other material", se: "annat material än sten eller is" });
