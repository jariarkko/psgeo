...
function PsgeoLang(language) {
    ...
    addTranslation("credits", { en: "psGeo GIS. Lead developer: Jari Arkko. Other developers: Ralf Strandell. Version {{string1}} ({{string2}}).", fi: "psGeo GIS. Pääkehittäjä: Jari Arkko. Muut kehittäjät: Ralf Strandell. Versio {{string1}} ({{string2}}).", sv: "psGeo GIS. Ledande utvecklare: Jari Arkko. Övriga utvecklare: Ralf Strandell. Version {{string1}} ({{string2}})." });
