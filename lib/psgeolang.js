...
function PsgeoLang(language) {
    ...
    addTranslation("distanceAndBearing", { en: "Distance: {{string1}} m. Bearing: {{string2}} degrees.", fi: "Etäisyys: {{string1}} m. Suuntima: {{string2}} astetta.", sv: "Avstånd: {{string1}} m. Bäring: {{string2}} grader."});
