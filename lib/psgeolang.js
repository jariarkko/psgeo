...
function PsgeoLang(language) {
    ...
    addTranslation("morphologyShort", { en: "type", fi: "tyyppi", se: "typ" });
    addTranslation("activity", { en: "activity", fi: "aktiviteetit", se: "aktiviteter" });
    addTranslation("caveActivity", { en: "cave activities", fi: "luola-aktiviteetit", se: "grott-aktiviteter" });
    ...
    addTranslation("snowboard", { en: "snowboarding", fi: "lumilautailua", se: "åka snowboard" });
    addTranslation("slide", { en: "sliding", fi: "liukua", se: "glidning" });
    ...
    addTranslation("bikeType", { en: "bike type", fi: "pyörätyyppi", se: "cykeltyp" });
    addTranslation("bikeTrack", { en: "trail type", fi: "reittityyppi", se: "rutetyp" });
    ...
    addTranslation("withCavemapShort", { en: "surveyed", fi: "kartoitetut", se: "karterade" });
    ...
    addTranslation("onlyFinland", { en: "Finland", fi: "Suomi", se: "Finland" });
    addTranslation("otherCountries", { en: "other countries", fi: "ulkomaat", se: "övriga länder" });
    ...
    addVocabularyItem(v,"glacier", { en: "glacier", fi: "jäätikkö", se: "glaciär" });
    addVocabularyItem(v,"ice", { en: "ice", fi: "jää", se: "is" });
    addVocabularyItem(v,"man-made", { en: "man-made", fi: "keinotekoinen", se: "artificiell" });
    addVocabularyItem(v,"material-other", { en: "other material", fi: "muu materiaali", se: "annat material än sten eller is" });
    ...
    addVocabularyItem(v,"other", { en: "in some other place", fi: "jossain muussa uimapaikassa", se: "i något annat simplats" });
    addVocabularyItem(v,"unknown", { en: "unknown place", fi: "ei tiedossa olevassa paikassa", se: "okänt plats" });
    ...
    addVocabularyItem(v,"waterbody-unknown", { en: "in an unknown waterbody", fi: "ei tiedossa olevassa vesialtaassa", se: "i ett okänt vattendrag" });
    ...
    addVocabularyItem(v,"other", { en: "in some other place", fi: "jossain muussa paikassa", se: "i annat plats" });
    addVocabularyItem(v,"none", { en: "not climbing", fi: "ei kiipeilyä", se: "inget klättring" });
    addVocabularyItem(v,"unknown", { en: "unknown climbing type", fi: "tuntematon kiipeilytyyppi", se: "okänt klättring" });
    ...
    addVocabularyItem(v,"none", { en: "not swimming", fi: "ei uintia", se: "inget simmandet" });
    addVocabularyItem(v,"material-other", { en: "in some other place", fi: "jossain muussa paikassa", se: "i annat plats" });
    addVocabularyItem(v,"material-unknown", { en: "unknown place type", fi: "tuntemattomassa uimapaikkatyypissä", se: "annat simplats" });
    ...
    addVocabularyItem(v,"substance-other", { en: "on other substances", fi: "muilla materiaaleilla", se: "på annat material" });
    ...
    addVocabularyItem(v,"substance-unknown", { en: "on unknown substance", fi: "ei tiedossa olevalla materiaalilla", se: "på okänt material" });
    ...
    addVocabularyItem(v,"indoor", { en: "indoors", fi: "sisällä", se: "innomhus" });
    addVocabularyItem(v,"underground", { en: "underground", fi: "maan alla", se: "under jorden" });
    addVocabularyItem(v,"unknown", { en: "unknown place", fi: "tuntemattomassa paikassa", se: "i okänt plats" });
    ...
    addVocabularyItem(v,"uphill-other", { en: "with some other method", fi: "jollain toisella tavalla", se: "på något annat sätt" });
    addVocabularyItem(v,"uphill-unknown", { en: "unknown method", fi: "ei tiedossa olevalla tavalla", se: "okänt sätt" });
    ...
    addVocabularyItem(v,"underground", { en: "underground", fi: "maan alla", se: "under jorden" });
    addVocabularyItem(v,"track-unknown", { en: "on an unknown track", fi: "ei tiedossa olevalla reitillä", se: "på okänt rute" });
    ...
    addVocabularyItem(v,"bike-unknown", { en: "on an unknown bike type", fi: "ei tiedossa olevalla pyörätyypillä", se: "på okänt cykeltyp" });
    ...
    addVocabularyItem(v,"other", { en: "other sauna", fi: "muu sauna", se: "annan bastu" });
    addVocabularyItem(v,"none", { en: "no sauna", fi: "ei saunaa", se: "ick bastu" });
