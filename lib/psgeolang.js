...
function PsgeoLang(language) {
    ...
    addTranslation("add", { en: "add", fi: "lisää", se: "visa mera", se: "lägg till" });	// NOTE
    addTranslation("orModify", { en: "or modify", fi: "tai korjaa", se: "eller uppdatera" });	// NOTE
    ...
    addVocabularyItem(v,"infrared", { en: "infrared sauna", fi: "infrapuna", se: "infraröd" });
    addVocabularyItem(v,"normal", { en: "Finnish sauna", fi: "suomalainen", se: "finsk bastu" });
