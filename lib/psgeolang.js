...
function PsgeoLang(language) {
    ...
    addVocabularyItem(v,"rock-granite", {
        en: "non-volcanic, non-sedimentary",
        fi: "muu kivi kuin vulkaaninen tai sedimentti"
    });
    addVocabularyItem(v,"rock-gypsum", {
        en: "gypsum",
        fi: "kipsi"
    });
    addVocabularyItem(v,"rock-limestone", {
        en: "limestone/dolomite",
        fi: "kalkkikivi/dolomiitti"
    });
    addVocabularyItem(v,"rock-marble", {
        en: "marble",
        fi: "marmori"
    });
    addVocabularyItem(v,"rock-mudrock", {
        en: "mudrock",
        fi: "savikivi"
    });
    addVocabularyItem(v,"rock-other", {
        en: "other rock",
        fi: "muu kivi"
    });
    addVocabularyItem(v,"rock-salt", {
        en: "salt",
        fi: "suola"
    });
    addVocabularyItem(v,"rock-sandstone", {
        en: "sandstone",
        fi: "hiekkakivi"
    });
    addVocabularyItem(v,"rock-unknown", {
        en: "unknown",
        fi: "ei tiedossa"
    });
    addVocabularyItem(v,"rock-volcanic", {
        en: "volcanic",
        fi: "vulkaaninen"
    });
    ...
    addVocabularyItem(v,"gravel", {
        en: "gravel",
        fi: "sora"
    });
    addVocabularyItem(v,"ice", {
        en: "ice",
        fi: "jää"
    });
    addVocabularyItem(v,"moraine", {
        en: "moraine",
        fi: "moreeni"
    });
    addVocabularyItem(v,"other-material", {
        en: "other material",
        fi: "other material"
    });
    addVocabularyItem(v,"rock", {
        en: "rock",        // see rockTypes for detailed classification
        fi: "kallio"
    });
    addVocabularyItem(v,"sand", {
        en: "sand",
        fi: "hiekka"
    });
    addVocabularyItem(v,"snow", {
        en: "snow",
        fi: "lumi"
    });
    addVocabularyItem(v,"turf", {
        en: "turf",
        fi: "turve"
    });
    ...
    addVocabularyItem(v,"morphology-boulders", {
        en: "boulder",
        fi: "lohkare"
    });
    addVocabularyItem(v,"morphology-crack", {
        en: "crevice",
        fi: "rako"
    });
    addVocabularyItem(v,"morphology-crystallization", {
        en: "blister",
        fi: "kideonkalo"
    });
    addVocabularyItem(v,"morphology-erosion", {
        en: "erosion",
        fi: "eroosio"
    });
    addVocabularyItem(v,"morphology-karst", {
        en: "karst",
        fi: "karsti"
    });
    addVocabularyItem(v,"morphology-organic", {
        en: "organic, reef or turf",
        fi: "koralli tai turve"
    });
    addVocabularyItem(v,"morphology-other", {
        en: "other",
        fi: "muu"
    });
    addVocabularyItem(v,"morphology-unknown", {
        en: "unknown",
        fi: "ei tiedossa"
    });
    addVocabularyItem(v,"morphology-volcanic", {
        en: "volcanic",
        fi: "vulkaaninen"
    });
    addVocabularyItem(v,"morphology-weathering", {
        en: "weathering",
        fi: "rapautumis"
    });
    ...
    addVocabularyItem(v,"basic", {
        en: "basic caving",
        fi: "luolailu"
    });
    addVocabularyItem(v,"biking", {
        en: "biking",
        fi: "pyöräily"
    });
    addVocabularyItem(v,"boating", {
        en: "boating",
        fi: "veneily"
    });
    addVocabularyItem(v,"digging", {
        en: "digging",
        fi: "kaivuu"
    });
    addVocabularyItem(v,"diving", {
        en: "diving",
        fi: "sukellus"
    });
    addVocabularyItem(v,"researching", {
        en: "researching",
        fi: "tutkimus"
    });
    addVocabularyItem(v,"skiing", {
        en: "skiing",
        fi: "hiihto"
    });
    addVocabularyItem(v,"srt", {
        en: "SRT",
        fi: "SRT"
    });
    addVocabularyItem(v,"studying", {
        en: "studying",
        fi: "oppiminen"
    });
    addVocabularyItem(v,"surveying", {
        en: "surveying",
        fi: "kartoitus"
    });
    addVocabularyItem(v,"swimming", {
        en: "swimming",
        fi: "uinti"
    });
    addVocabularyItem(v,"training", {
        en: "training",
        fi: "opetus"
    });
    ...
    addVocabularyItem(v,"beach", {
        en: "on an official beach",
        fi: "virallisella uintipaikalla"
    });
    addVocabularyItem(v,"indoor", {
        en: "indoors",
        fi: "sisällä"
    });
    addVocabularyItem(v,"nature", {
        en: "in nature",
        fi: "luonnon rannalla"
    });
    addVocabularyItem(v,"outdoor", {
        en: "outdoors",
        fi: "ulkona"
    });
    addVocabularyItem(v,"thermal-bath", {
        en: "in a thermal bath",
        fi: "kuumassa lähteessä"
    });
    addVocabularyItem(v,"underground", {
        en: "underground",
        fi: "maan alla"
    });
    addVocabularyItem(v,"waterbody-cave", {
        en: "in a cave",
        fi: "luolassa"
    });
    addVocabularyItem(v,"waterbody-lake", {
        en: "on a lake",
        fi: "järvellä"
    });
    addVocabularyItem(v,"waterbody-other", {
        en: "in some other body of water",
        fi: "jossain muussa vesialtaassa"
    });
    addVocabularyItem(v,"waterbody-pool", {
        en: "in a swimming pool",
        fi: "uimaaltaassa"
    });
    addVocabularyItem(v,"waterbody-river", {
        en: "on a river",
        fi: "joessa"
    });
    addVocabularyItem(v,"waterbody-sandpit", {
        en: "in a sandpit",
        fi: "hiekkakuopalla"
    });
    addVocabularyItem(v,"waterbody-sea", {
        en: "in the sea",
        fi: "meressä"
    });
    addVocabularyItem(v,"waterbody-unknown", {
        en: "unknown",
        fi: "ei tiedossa"
    });
    ...
    addVocabularyItem(v,"ash", {
        en: "on ash",
        fi: "tuhkalla"
    });
    addVocabularyItem(v,"asphalt", {
        en: "on asphalt",
        fi: "asfaltilla"
    });
    addVocabularyItem(v,"grass", {
        en: "on grass",
        fi: "nurmikolla"
    });
    addVocabularyItem(v,"imported-snow", {
        en: "on carried snow",
        fi: "kannetulla lumella"
    });
    addVocabularyItem(v,"mud", {
        en: "in mud",
        fi: "mudassa"
    });
    addVocabularyItem(v,"other-substances", {
        en: "on other substances",
        fi: "muilla materiaaleilla"
    });
    addVocabularyItem(v,"plastic", {
        en: "on plastic",
        fi: "muovilla"
    });
    addVocabularyItem(v,"rock", {
    ...
    addVocabularyItem(v,"unknown-substance", {
        en: "unknown",
        fi: "ei tiedossa"
    });
    ...
    addVocabularyItem(v,"airports", {
        en: "an airport",
        fi: "lentokenttä"
    });
    addVocabularyItem(v,"amusement-parks", {
        en: "an amusement park",
        fi: "huvipuisto"
    });
    addVocabularyItem(v,"bridges", {
        en: "a bridge",
        fi: "silta"
    });
    addVocabularyItem(v,"buildings", {
        en: "a building",
        fi: "rakennus"
    });
    addVocabularyItem(v,"bunkers", {
        en: "a bunker",
        fi: "bunkkeri"
    });
    addVocabularyItem(v,"castles", {
        en: "a castle",
        fi: "linna"
    });
    addVocabularyItem(v,"catacombs", {
        en: "a catacomb",
        fi: "katakombi"
    });
    addVocabularyItem(v,"harbours", {
        en: "a harbour",
        fi: "satama"
    });
    addVocabularyItem(v,"historic-sites", {
        en: "a historic site",
        fi: "historiallinen paikka"
    });
    addVocabularyItem(v,"industrial", {
        en: "an industrial site",
        fi: "teollisuus"
    });
    addVocabularyItem(v,"landfills", {
        en: "a landfill",
        fi: "kaatopaikka"
    });
    addVocabularyItem(v,"memorial", {
        en: "a memorial",
        fi: "muistomerkki"
    });
    addVocabularyItem(v,"military", {
        en: "a military site",
        fi: "sotilaallinen kohde"
    });
    addVocabularyItem(v,"mines", {
        en: "a mine",
        fi: "kaivos"
    });
    addVocabularyItem(v,"none", {
        en: "nothing",
        fi: "ei mikään"
    });
    addVocabularyItem(v,"other", {
        en: "other",
        fi: "jokin muu"
    });
    addVocabularyItem(v,"prisons", {
        en: "a prison",
        fi: "vankila"
    });
    addVocabularyItem(v,"quarries", {
        en: "a quarry",
        fi: "louhis"
    });
    addVocabularyItem(v,"railways", {
        en: "a railway",
        fi: "rautatie"
    });
    addVocabularyItem(v,"ruins", {
        en: "ruins",
        fi: "rauniot"
    });
    addVocabularyItem(v,"silos", {
        en: "a silo",
        fi: "siilo"
    });
    addVocabularyItem(v,"skating-rinks", {
        en: "a skating rink",
        fi: "luistelukenttä"
    });
    addVocabularyItem(v,"ski-lifts", {
        en: "a ski lift",
        fi: "hiihtohissi"
    });
    addVocabularyItem(v,"smokestacks", {
        en: "a smokestack",
        fi: "piippu"
    });
    addVocabularyItem(v,"towers", {
        en: "a tower",
        fi: "torni"
    });
    addVocabularyItem(v,"trenches", {
        en: "a trench",
        fi: "juoksuhauta"
    });
    addVocabularyItem(v,"tunnels", {
        en: "a tunnel",
        fi: "tunneli"
    });
    addVocabularyItem(v,"unknown", {
        en: "unknown",
        fi: "ei tiedossa"
    });
    addVocabularyItem(v,"vehicles", {
        en: "a vehicle",
        fi: "kulkuväline"
    });
    ...
    addVocabularyItem(v,"track-city", {
        en: "in city",
        fi: "kaupungissa"
    });
    addVocabularyItem(v,"track-nature", {
        en: "in the nature",
        fi: "luonnossa"
    });
    addVocabularyItem(v,"track-road", {
        en: "on roads",
        fi: "maanteillä"
    });
    addVocabularyItem(v,"track-trail", {
        en: "on a trail",
        fi: "poluilla"
    });
    addVocabularyItem(v,"underground", {
    ...
    addVocabularyItem(v,"bike-city", {
        en: "on a city bike",
        fi: "kaupunkipyörällä"
    });
    addVocabularyItem(v,"bike-mountain", {
        en: "on an MTB",
        fi: "maastopyörällä"
    });
    addVocabularyItem(v,"bike-other", {
        en: "on special bike type",
        fi: "erikoispyörällä"
    });
    addVocabularyItem(v,"bike-road", {
        en: "on a road bike",
        fi: "maantiepyörällä"
    });
    addVocabularyItem(v,"bike-tandem", {
        en: "on a tandem bike",
        fi: "tandem-pyörällä"
    });
    addVocabularyItem(v,"bike-tricycle", {
        en: "on a tricycle",
        fi: "kolmipyöräisellä"
    });
    addVocabularyItem(v,"bike-unicycle", {
        en: "on an unicycle",
        fi: "yksipyöräisellä"
    });
    ...
    addVocabularyItem(v,"infrared", {
        en: "infrared sauna",
        fi: "infrapuna"
    });
    addVocabularyItem(v,"normal", {
        en: "Finnish sauna",
        fi: "suomalainen"
    });
    addVocabularyItem(v,"smoke", {
        en: "smoke sauna",
        fi: "savusauna"
    });
    addVocabularyItem(v,"steam", {
        en: "Turkish sauna",
        fi: "höyrysauna"
    });
    addVocabularyItem(v,"unknown", {
