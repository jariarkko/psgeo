...
function PsgeoLang(language) {
    ...
    addTranslation("map", { en: "map", fi: "kartta", se: "karta" });
    addTranslation("caveMap", { en: "cave map", fi: "luolakartta", se: "grottkarta" });
    ...
    addTranslation("up", { en: "going up", fi: "ylös" });
    addTranslation("climbingTypeText", { en: "climbing type", fi: "kiipeilytyyppi" });
    addTranslation("climbingTypeIs", { en: "climbing type is", fi: "kiipeilytyyppi on" });
    addTranslation("place", { en: "place", fi: "paikka" });
    ...
    addTranslation("openInNewWindow",
        {
            ...
            fi: "työkalut avautuvat uudessa välilehdessä"
        });
    ...
    addVocabularyItem(v,"mountain", { en: "mountain", fi: "vuoristo" });
    addVocabularyItem(v,"rock", { en: "rock", fi: "kalliokiipeily" });
    addVocabularyItem(v,"wall", { en: "wall", fi: "seinäkiipeily" });
    addVocabularyItem(v,"ice", { en: "ice", fi: "jääkiipeily" });
    addVocabularyItem(v,"volcanoes", { en: "volcanoes", fi: "tulivuorikiipeily" });
    ...
    addVocabularyItem(v,"snow", { en: "on snow", fi: "lumella" });
    ...
    addVocabularyItem(v,"lifts", { en: "with a lift", fi: "hissillä" });
    addVocabularyItem(v,"heli", { en: "with a helicopter", fi: "helikopterilla" });
    addVocabularyItem(v,"hiking", { en: "by hiking", fi: "kävelemällä" });
    addVocabularyItem(v,"skinning", { en: "by skinning", fi: "nousukarvoilla" });
    addVocabularyItem(v,"car", { en: "with a car", fi: "autolla" });
    addVocabularyItem(v,"bus", { en: "with a bus", fi: "bussilla" });
    addVocabularyItem(v,"train", { en: "with a train", fi: "junalla" });
    addVocabularyItem(v,"horse", { en: "with a horse", fi: "hevosella" });
    addVocabularyItem(v,"dogs", { en: "with dogs", fi: "koiravaljakolla" });
    addVocabularyItem(v,"other-uphill", { en: "with some other method", fi: "jollain toisella tavalla" });
    addVocabularyItem(v,"unknown-uphill", { en: "unknown", fi: "ei tiedossa" });
    ...
    function listToText(list) {
        ...
        // Configuration
        const listSeparator=", ";
        const lastSeparator=" " + getText("and") + " ";
