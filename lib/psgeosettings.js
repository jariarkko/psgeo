    ...
    const psgeoDomainDefaults = [
        ...
        },
        {
            ...
            sources: [
                ...
                {textId: "Luolaseura", datafile: "https://www.planetcaver.net/locations.caving.json"}
            ],
            lat: 65.4,
            lng: 24.6,
            zoom: 5,
        ...
        {
            domains: ["luolaseura.fi"],
            paths: ["luolakanta"],
            sources: [
                {textId: "Luolaseura", datafile: "https://luolaseura.fi/luolakanta/db/caves.luolaseura.json"},
                {textId: "Luolaseura", datafile: "https://www.planetcaver.net/locations.caving.json"}
            ],
            lat: 65.4,
            lng: 24.6,
