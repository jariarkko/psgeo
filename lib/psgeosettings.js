    ...
    const psgeoDomainDefaults = [
        {
            ...
            paths: [],
            sources: [
                {textId: "Planetcaver", datafile: "https://www.planetcaver.net/locations.json", descriptionTextId: "dataExplanation"}
            ],
            lat: 0,
            lng: 0,
            zoom: 2,
            ...
            customLink1: {text: "", icon: "", url: ""},
            customLink2: {text: "", icon: "", url: ""},
            customLink3: {text: "", icon: "", url: ""},
            ...
            rangeFilter: {measure: "length", unit: "meters", limitLow: 5, limitHigh: 50},
            nameSearch: true,
        ...
        },
        {
            ...
            paths: [],
            sources: [
                {textId: "Luolaseura", datafile: "https://kartta.luolaseura.fi/db/caves.luolaseura.json", descriptionTextId: "dataExplanationCavingAssociation"},
                {textId: "Planetcaver", datafile: "https://www.planetcaver.net/locations.caving.json", descriptionTextId: ""}
            ],
            lat: 65.4,
            lng: 24.6,
            zoom: 5,
            ...
            icons: psgeoDefaultIcons,
            geolocationContinuousUpdate: true,
            richPositionInfo: true,rangeFilter: {measure: "length", unit: "meters", limitLow: 5, limitHigh: 50},
            classicUI:false
        },
        {
            ...
            paths: [""],
            sources: [
                {textId: "Luolaseura", datafile: "https://dev.luolaseura.fi/db/caves.luolaseura.json", descriptionTextId: "dataExplanationCavingAssociation"},
                {textId: "Planetcaver", datafile: "https://www.planetcaver.net/locations.caving.json", descriptionTextId: ""}
            ],
            lat: 65.4,
            lng: 24.6,
        ...
        },
        {
            ...
            paths: [],
            sources: [
                {textId: "Planetswimmer", datafile: "https://www.planetswimmer.com/locations.json", descriptionTextId: "dataExplanation"}
            ],
            lat: 0,
            lng: 0,
            zoom: 2,
