...
function PsgeoTables()
{
    ...
    const psgeoStatLinesGeneral = {
        ...
        model3d:  { true:   psgeoStatLineEmpty,             false: psgeoStatLineEmpty             }
    };
    ...
    const psgeoStatLinesCaving = {
        ...
        cavemap:  { true:   psgeoStatLineNumberOfMaps,      false: psgeoStatLineNumberOfMaps  },
        model3d:  { true:   psgeoStatLineEmpty,             false: psgeoStatLineNumberOf3Dmodels  }
    };
    ...
    const psgeoSubtypeGroups = [
        ...
        //
        // Diving includes both waterbody types (both natural and man-made)
        // and tasks typically performed at the site. First place types:
        //
        
        {
            selector: "divingEnvironmentSearch",
            displaySizeSelector: { true: true, false: true },
            descriptionTextId: "place",
            activities: ["Diving"],
            getSubActivitiesFunction: "getDivingEnvironmentSubActivities",
            getSubActivitiesFunctionArgument: false,
            extraSubActivitiesBefore: [],
            extraSubActivitiesAfter: ["Unknown"],
            subActivityCollection: "divingEnvironment"
        },
        
        {
            selector: "divingTaskSearch",
            displaySizeSelector: { true: true, false: true },
            descriptionTextId: "task",
            activities: ["Diving"],
            getSubActivitiesFunction: "getDivingTaskSubActivities",
            getSubActivitiesFunctionArgument: false,
            extraSubActivitiesBefore: [],
            extraSubActivitiesAfter: ["Unknown"],
            subActivityCollection: "divingTask"
        },
