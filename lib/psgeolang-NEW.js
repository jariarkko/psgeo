...
//	RETURN AN OBJECT
    ...
    var nimisampoNameTexts = [];
    nimisampoNameTexts["en"] = "Nimisampo - Placename research tool";
    nimisampoNameTexts["fi"] = "Nimisampo - Nimistötutkijan työpöytä";

    var nimisampoDescriptionTexts = [];
	...
	function getText(textId) {
		...
		// EVEN SHORTER:
		// 	var translationArrayName = textId + "Texts";
		...
		switch (textId) {
			...
			case "filterTextHeader": 	return(genText(filterTextHeaderTexts)); break;
			case "filterTextLink": 		return(genText(filterTextLinkTexts)); break;
			...
			case "nimisampoName": 		return(genText(nimisampoNameTexts)); break;
			case "nimisampoDescription": 	return(genText(nimisampoDescriptionTexts)); break;
			default:
		}
	}
	...
	function getTextValue(textId,value) {
		...
		if ( textId == "rockTypeAndOtherMaterial" ) {
			switch (value) {
				"ice": return(getText(value)); break;
				"other-material": return(getText("otherMaterial")); break;
				default: return(getTextValue(value,"rockType"))			// TARKISTA
			}
		}

		switch (textId) {
			case "rockType":		return(genValueText(value,rockTypeValueTexts));
			case "morphology":		return(genValueText(value,morphologyValueTexts));
			case "swimming":		return(genValueText(value,swimmingValueTexts));
			case "swimmingMaterial":	return(genValueText(value,swimmingMaterialValueTexts));
			case "skiMaterial":		return(genValueText(value,skiMaterialValueTexts));
			case "urbanexTarget":		return(genValueText(value,urbanexTargetTexts));
			case "bikeTrack":		return(genValueText(value,bikeTrackValueTexts));
			case "bikeType":		return(genValueText(value,bikeTypeValueTexts));
			case "saunaType":		return(genValueText(value,saunaTypeValueTexts));
			case "cavingActivity":		return(genValueText(value,cavingActivityValueTexts));
			default:
		}
	}
	// IDEA
