...
var secondmodellist = [
    {"n": "Grottbergetin luola, Siuntio",
     "lat": 39.904, "lon": 116.391,
     "k": "Siuntio", "c": "Finland", "o": "Europe",
     "l": 10,
     "m": "https://example.com/map-inferiorA.pdf",
     "d3": "https://example.com/model-inferiorB.glb",
     "ad3": ["https://example.com/model-inferiorC.stl"],
     "rl": [{ "t": "3D test other item", "y": 2021, "m": 3,
              "w": ["Jari Arkko"],
              "a": ["Caving"], "sa": [["Basic","Rock","Surveying"]] }]},
];
var modeldb = PsgeoDB(lib,modellist,"model");
modeldb.addPlaces(secondmodellist,"inferior dataset");
