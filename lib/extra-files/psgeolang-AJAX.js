...
//   var lang = "fi";
//   var citiesText = langLib.get("cities"); // "paikkakuntaa"
//  


//////////////////////////////////////////////
// THIS IS AN EXAMPLE FILE
//    HOW I TRIED TO SHORTEN PSGEOLANG
//    BUT THERE ARE UNRESOLVED ISSUES.
// EXPERIMENTAL - FOR REVIEW ONLY
//////////////////////////////////////////////
...
function PsgeoLang(language) {
	...
	$.ajax({
		url:		"./psgeolang-base-init.js",
		dataType:	"script",
		success:	psgeoDebug("Language module initialized.")
	});

	// OR SHORTENED BY JQUERY: $.getScript("./psgeolang-base-init.js",psgeoDebug("Language module initialized."));

	// load english texts
	$.ajax({
		url:		"../lang/psgeolang-base-en.js",
		dataType:	"script",
