...
function PsgeoDB(lib,listin,source) {
    ...
    //   always true.
    //
    // - negation is a boolean, and should be set to true if the condition
    //   is actually that the string in the condition field should NOT
    //   appear for the condition to hold.
    //
    ...
    const subActivityDescriptionTable = [
        ...
        //
        // Climbing: here we have the climbing type (Montain, Wall, etc.)
        //
