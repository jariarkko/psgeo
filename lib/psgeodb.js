...
function PsgeoDB(lib,listin,source) {
    ...
    function itemDescriptionSaunaType(lang,item,useHtml,conserveSpace) {
        ...
        if (usesDefaults && conserveSpace) {
            ...
            for (var i = 0; i < places.length; i++) {
                ...
                result += lang.getTextCollectionItem("saunaType",places[i].toLowerCase()); // NEW
            }
            result += ".";
    ...
    function itemDescriptionSwimmingPlace(lang,item,useHtml,conserveSpace) {
        ...
        if (usesDefaults && conserveSpace) {
            ...
            for (var i = 0; i < places.length; i++) {
                ...
                result += lang.getTextCollectionItem("swimmingPlace",places[i].toLowerCase()); // NEW
            }
            ...
            for (var j = 0; j < materials.length; j++) {
                ...
                result += lang.getTextCollectionItem("swimmingMaterial",materials[j].toLowerCase()); // NEW
            }
            result += ".";
            return(result);
        }
        ...
        if (usesDefaults && conserveSpace) {
            ...
            if (indoor && outdoor) {
                result +=
                    lang.getText("indoor") + " " +
                    lang.getText("and") + " " +
                    lang.getText("outdoor") + " ";
            } else if (indoor) {
                result += lang.getText("indoor") + " ";
            } else if (outdoor) {
                result += lang.getText("outdoor") + " ";
            }
            for (var j = 0; j < materials.length; j++) {
                if (j > 0 && j < materials.length - 1) result += ", ";
                else if (j > 0 && j == materials.length -1) result += " " + lang.getText("and") + " ";
                // result += lang.skiMaterialValueText(materials[j].toLowerCase());
                result += lang.getTextCollectionItem("skiMaterial",materials[j].toLowerCase()); // NEW
            }
            result += ".";
            return(result);
        }
    ...
    function itemDescriptionBikingTrackAndBikeType(lang,item,useHtml,conserveSpace) {
        ...
        if (!isitem(item)) throw ("Not a dataset item");
	// NOTE vocabularies.bikeTrack[i] contains this list: (and would be extensible!)
        var placeTypes = ["Track-City","Track-Road","Track-Trail","Track-Nature","Outdoor","Indoor","Underground"];
	// NOTE vocabularies.bikeType[i] contains this list: (and would be extensible!)
        ...
        for (var i = 0; i < bikes.length; i++) {
            ...
            result += lang.getTextCollectionItem("bikeType",bikes[i].toLowerCase()); // NEW
        }
        ...
        for (var j = 0; j < places.length; j++) {
            ...
            result += lang.getTextCollectionItem("bikeTrack",places[j].toLowerCase()); // NEW
        }
        result += ".";
        return(result);
    }
    ...
    function itemDescriptionUrbanExplorationTarget(lang,item,useHtml,conserveSpace) {
        ...
        var result = lang.capitalize(lang.getText("target")) + " ";
         //debug("targets = " + JSON.stringify(targets));
        for (var i = 0; i < targets.length; i++) {
            if (i > 0 && i < targets.length - 1) result += ", ";
            else if (i > 0 && i == targets.length -1) result += " " + lang.getText("and") + " ";
            // result += lang.urbanexTargetValueText(targets[i].toLowerCase());
            result += lang.getTextCollectionItem("urbanexTarget",targets[i].toLowerCase()); // NEW
        }
        result += ".";
        return(result);
    }
