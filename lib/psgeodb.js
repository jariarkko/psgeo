...
function PsgeoDB(lib,listin,source) {
    ...
    function normalizeItemFields(place,source) {
        ...
        //debug("after finnish check rl = " + JSON.stringify(place.rl));
    ...
    function findFinnishCaveType(text) {
        var index = text.search(/{[ABCD123EFGHIJKL ,jaMNORV4Zf]+}/);
    ...
    function addFinnishCaveCategories(item,type) {
        //debug("add finnish category " + type);
        while (type.length > 0) {
            var found = false;
        ...
        //debug("after the entry is " + JSON.stringify(item));
    }
    ...
    //
    // The table provides a lot of flexibility to control how the sub-activity groups are represented in natural language.
    // Some groups might be joined together, e.g., if A, B, and C form one group and D, E, and F another
    //
    ...
    //                 in the list.
    //
    // - headerTextId  The textid for the language object, to be used for printing a
    //                 header, e.g., "ski"
    //
    // - colonAfterHeader
    ...
    const subActivityDescriptionTable = [
        { activities: ["Sauna"],
          subActivitySets: [
              { subActivities: lib.getSaunaSaunaTypeSubActivities(true),
                defaultItem: "Normal",
                omitEmpty: true,
                omitDefault: false,
                headerTextId: undefined,
    ...
    function descriptionTitle(lang,text,useHtml,conserveSpace) {
        ...
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
    ...
    function descriptionImage(lang,url,useHtml,conserveSpace) {
        ...
        if (!isstring(url)) throw ("URL is not a string");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
        if (useHtml) {
            if (conserveSpace) {
    ...
    function descriptionTextAdd(lang,text1,text2,useHtml,conserveSpace) {
        ...
        if (!isstring(text1)) throw ("Text1 is not a string");
        if (!isstring(text2)) throw ("Text2 is not a string");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
        if (text1.length == 0) {
            return(text2);
    ...
    function descriptionNameToURL(lang,name,useHtml,conserveSpace) {
        if (!islang(lang)) throw ("Not a language object in descriptionTextLine");
        if (!isstring(name)) throw ("Name is not a string");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
    ...
    function descriptionLink(lang,link,url,useHtml,conserveSpace) {
        ...
        if (!isstring(link)) throw ("Link is not a string");
        if (!isstring(url)) throw ("URL is not a string");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
        if (useHtml) {
    ...
    function descriptionCoordinates(lang,lat,lon,includetext,useHtml,conserveSpace) {
        ...
        if (!isboolean(includetext)) throw ("Includetext is not a boolean");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
    ...
    function itemDescriptionAuxRLItemPublication(lang,item,rli,authorsandyear,useHtml,conserveSpace) {
        ...
        if (!isitem(item)) throw ("Not a dataset item");
        if (!isreadinglistitem(rli)) throw ("Not a reading list item");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
    ...
    function itemDescriptionSwimmingPlace(lang,item,useHtml,conserveSpace) {
        ...
        return(itemDescriptionGenericSubActivities(lang,
                                                   item,
                                                   ["Swimming"],
                                                   [{ subActivities: lib.getSwimmingPlaceSubActivities(),
                                                      defaultItem: undefined,
                                                      omitEmpty: false,
                                                      omitDefault: false,
                                                      headerTextId: "swimming",
                                                      colonAfterHeader: false,
                                                      itemTextId: "swimmingPlace",
                                                      useCommaAsItemSeparator: true,
                                                      sentence: false,
                                                      useCommaAfterList: true},
                                                    { subActivities: lib.getSwimmingMaterialSubActivities(),
                                                      defaultItem: "Water",
                                                      omitEmpty: false,
                                                      omitDefault: false,
                                                      headerTextId: undefined,
    ...
    function itemDescriptionSkiingPlaceUphillAndMaterial(lang,item,useHtml,conserveSpace) {
        ...
        return(itemDescriptionGenericSubActivities(lang,
                                                   ...
                                                   [{ subActivities: lib.getSkiingPlaceSubActivities(),
                                                      defaultItem: "Outdoor",
                                                      omitEmpty: false,
                                                      omitDefault: false,
                                                      headerTextId: "ski",
                                                      ...
                                                      sentence: false,
                                                      useCommaAfterList: true},
                                                    { subActivities: lib.getSkiingSubstanceSubActivities(),
                                                      defaultItem: "Snow",
                                                      omitEmpty: false,
                                                      omitDefault: false,
                                                      headerTextId: undefined,
                                                      ...
                                                      sentence: true,
                                                      useCommaAfterList: false},
                                                    { subActivities: lib.getSkiingUphillSubActivities(),
                                                      defaultItem: "Lifts",
                                                      omitEmpty: false,
                                                      omitDefault: false,
                                                      headerTextId: "up",
    ...
    function itemDescriptionBikingTrackAndBikeType(lang,item,useHtml,conserveSpace) {
        ...
        return(itemDescriptionGenericSubActivities(lang,
                                                   item,
                                                   ["Biking"],
                                                   [{ subActivities: lib.getBikingBikeTypeSubActivities(),
                                                      defaultItem: undefined,
                                                      omitEmpty: false,
                                                      omitDefault: false,
                                                      headerTextId: "biking",
                                                      ...
                                                      sentence: false,
                                                      useCommaAfterList: false},
                                                    { subActivities: lib.getBikingBikeTrackSubActivities(),
                                                      defaultItem: undefined,
                                                      omitEmpty: false,
                                                      omitDefault: false,
                                                      headerTextId: undefined,
    ...
    function itemDescriptionGenericCharacteristics(lang,
                                                   item,
                                                   useHtml,
                                                   conserveSpace) {
        ...
        if (!isitem(item)) throw ("Not a dataset item in itemDescriptionGenericCharacteristics");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean in itemDescriptionGenericCharacteristics");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean in itemDescriptionGenericCharacteristics");
        ...
        for (var i = 0; i < subActivityDescriptionTable.length; i++) {
            ...
            var one =
                itemDescriptionGenericSubActivities(lang,
                                                    item,
                                                    entry.activities,
    ...
    function itemDescriptionGenericSubActivities(lang,
        ...
        if (!isitem(item)) throw ("Not a dataset item");
        if (!isarray(subActivitySets)) throw ("Not a list of sub activity sets");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
        ...
        if (!hasItemActivities(item,activities)) {
            return("");
        }
        ...
        for (var k = 0; k < subActivitySets.length; k++) {
            ...
            if (!isboolean(subActivitySet.omitEmpty)) throw("omitEmpty is not a boolean");
            if (!isboolean(subActivitySet.omitDefault)) throw("omitDefault is not a boolean");
            if (!isboolean(subActivitySet.sentence)) throw("sentence is not a boolean");
            if (!isboolean(subActivitySet.colonAfterHeader)) throw("colonAfterHeader is not a boolean");
            if (!isboolean(subActivitySet.useCommaAsItemSeparator)) throw("useCommaAsItemSeparator is not a boolean");
            if (!isboolean(subActivitySet.useCommaAfterList)) throw("useCommaAfterList is not a boolean");
            var items = getItemMultiSubActivitiesWithinSet(item,activities,subActivitySet.subActivities);
        ...
        for (var k = 0; k < subActivitySets.length; k++) {
            ...
            if (subActivitySet.headerTextId !== undefined) {
                var header = lang.getText(subActivitySet.headerTextId);
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                if (k == 0 && i == 0 && subActivitySet.headerTextId === undefined) {
    ...
    function itemDescriptionAlternateNames(lang,item,useHtml,conserveSpace) {
        ...
        if (!isitem(item)) throw ("Not a dataset item in itemDescriptionAlternativeNames");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
        if (conserveSpace) {
            return("");
    ...
    function itemDescriptionCavingRockMorphologyActivities(lang,item,useHtml,conserveSpace) {
        if (!islang(lang)) throw ("Not a language object in itemDescriptionCavingRockMorphology");
        if (!isitem(item)) throw ("Not a dataset item in itemDescriptionCavingRockMorphology");
        if (!isboolean(useHtml)) throw("useHtml is not a boolean");
        if (!isboolean(conserveSpace)) throw("conserveSpace is not a boolean");
        return(itemDescriptionGenericSubActivities(lang,
                                                   item,
    ...
    function describeItem(lang,
        ...
        characteristics = descriptionTextAdd(lang,
                                             characteristics,
                                             itemDescriptionCavingRockMorphologyActivities(lang,item,useHtml,conserveSpace),
                                             useHtml,conserveSpace);
        ...
        characteristics = descriptionTextAdd(lang,
                                             characteristics,
                                             itemDescriptionGenericCharacteristics(lang,item,useHtml,conserveSpace),
                                             useHtml,conserveSpace);
