...
function PsgeoDB(lib,listin,source) {
    ...
    function itemDescriptionGenericSubActivities(lang,
        ...
        //                 header, e.g., "ski"
        // - colon         A boolean, true if the header should follow a colon and a space.
        ...
        for (var k = 0; k < subActivitySets.length; k++) {
            ...
            if (!isboolean(subActivitySet.colon)) throw("useCommaAfterListt is not a boolean");
            ...
            subActivityEmpty[k] =
                (items.length == 0 ||
                 (items.length == 1 && subActivitySet.emptyItem !== undefined && items[0] === subActivitySet.emptyItem));
            if (!subActivityEmpty[k]) {
                hasContent = true;
            }
        }
        ...
        for (var k = 0; k < subActivitySets.length; k++) {
            ...
            if (conserveSpace && subActivityEmpty[k]) continue;
