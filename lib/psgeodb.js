...
function PsgeoDB(lib,listin,source) {
    ...
    function itemDescriptionSwimmingPlace(lang,item,useHtml,conserveSpace) {
        if (!islang(lang)) throw ("Not a language object");
        if (!isitem(item)) throw ("Not a dataset item");
        var placeTypes = ["Outdoor","Indoor","Underground","Waterbody-Lake","Waterbody-River","Waterbody-Sea","Waterbody-Sandpit","Waterbody-Pool","Waterbody-Cave","Waterbody-Other","Beach","Nature","Thermal-Bath"];
    ...
    function describeItem(lang,
        ...
        html += itemDescriptionSaunaType(lang,item,useHtml,conserveSpace);

        //
        // Output any swimming-related characteristics
        //
        
        html += itemDescriptionSwimmingPlace(lang,item,useHtml,conserveSpace);
        
        //
        // Output any skiing-related characteristics
        //
        
        html += itemDescriptionSkiingPlaceAndMaterial(lang,item,useHtml,conserveSpace);

        //
        // Output any biking-related characteristics
        //

        html += itemDescriptionBikingTrackAndBikeType(lang,item,useHtml,conserveSpace);
        
        //
        // Output any urban exploration -related characteristics
        //

        html += itemDescriptionUrbanExplorationTarget(lang,item,useHtml,conserveSpace);
        
        //
        // Output any general activities
        //
