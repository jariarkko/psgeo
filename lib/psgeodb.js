...
function PsgeoDB(lib,listin,source) {
    ...
    function normalizeItemFields(place,source) {
        ...
        if (place.d !== undefined) {
            ...
            // HUOM KAIKKI KIELET !!!! NOTE HUU
            // if (isstring(place.d)) {
            //    type = findFinnishCaveType(place.d);
            // } else { // for-IN-loop goes through the properties of an object
            //    for ( const descriptionTranslation in place.d ) {
            //        if ( descriptionTranslation ... KESKEN
            //    }
            // }
