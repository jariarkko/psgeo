...
function PsgeoDB(lib,listin,source) {
    ...
    function itemDescriptionSwimmingPlace(lang,item,useHtml,conserveSpace) {
        if (!islang(lang)) throw ("Not a language object");
        if (!isitem(item)) throw ("Not a dataset item");
        var placeTypes = ["Outdoor","Indoor","Underground","Waterbody-Lake","Waterbody-River","Waterbody-Sea","Waterbody-Sandpit","Waterbody-Pool","Waterbody-Cave","Waterbody-Other","Beach","Nature"];
