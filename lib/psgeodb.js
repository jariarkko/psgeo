...
function PsgeoDB(lib,listin,source) {
    ...
    const finnishCaveTypes = [
        ...
        {
            letter: "C1",        // could be limestone, could be gypsum karst too
            classification: ["Rock","Rock-Limestone","Morphology-Karst"]
        },
        {
            letter: "C2",        // could be limestone, could be gypsum karst too
            classification: ["Rock","Rock-Gypsum","Morphology-Karst"]
        },
        {
            letter: "C3",        // could be limestone, could be gypsum karst too
