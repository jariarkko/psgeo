    ...
    function normalizeItemFields(place,source) {
        ...
        if (id !== undefined) {
            ...
            addDescriptions(place,
                            { d: { en: "A cave from the book Suomen luolat. The book's code for this cave is " + id + "." + moretexten,
                                   fi: "Suomen luolat -kirjan luolia. Kirjan koodi luolalle "  + id + "." + moretextfi },
                              s: source },
                            source);
        }
