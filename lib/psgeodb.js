...
function PsgeoDB(lib,listin,source) {
    ...
    function itemSubsumedByAnother(mainitem,otheritem) {
        ...
        var paran = cleanedupname.indexOf(" (");
        if (paran > 0) cleanedupname = cleanedupname.substring(0,paran);
    ...
    function addCoordinates(item,lat,lon) {
    ...
    function subsumeItem(tab,mainitem,otheritem,why) {
        ...
        addCoordinates(mainitem,otheritem.lat,otheritem.lon);
